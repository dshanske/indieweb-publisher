...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
	...
	<header class="entry-header">
      ...
      <span class="entry-title-meta-author">
		...
		indieweb_publisher_posted_author() ?></span>
				<?php if ( get_post_meta( get_the_ID(), 'indieweb_publisher_primary_category', true ) ) { // check for a custom field named 'indieweb_publisher_primary_category'
				...
				} else if ( indieweb_publisher_categorized_blog() ) {
