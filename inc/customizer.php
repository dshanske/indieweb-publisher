...
/**
 * Indiweb Publisher Theme Customizer
 *
 ...
 * @return int|string
 */
function indieweb_publisher_sanitize_checkbox( $input ) {
	if ( $input == 1 ) {
		return 1;
	} else {
		return '';
...
add_action( 'customize_register', array( 'IndiewebPublisher_Customize', 'register' ) );

// Enqueue live preview javascript in Theme Customizer admin screen
add_action( 'customize_preview_init', array( 'IndiewebPublisher_Customize', 'live_preview' ) );
