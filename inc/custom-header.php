 ...
 */
function indieweb_publisher_custom_header_setup() {
	$args = array(
		'default-image'          => indieweb_publisher_get_default_header_image(),
		'width'                  => 100,
		'height'                 => 100,
		'flex-width'             => true,
		'flex-height'            => true,
...
add_action( 'after_setup_theme', 'indieweb_publisher_custom_header_setup' );
...
} // indieweb_publisher_get_default_header_image
